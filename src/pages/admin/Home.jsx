  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-10">
        <h1 className="text-4xl text-white">Good morning, jaydev!</h1>
      ...
      <div>
        <h1 className="text-2xl text-white my-10">Tickets mas recientes</h1>
      </div>
      <div className="bg-secondary-100 p-8 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 bg-secondary-900 p-4 rounded-xl">
          ...
          <div>
          <h5 className="md:hidden text-white font-bold mb-2">Estatus</h5>
            <span className="py-1 px-2 bg-blue-500/10 text-blue-500 rounded-lg">En proceso</span>
          </div>
          <div>
          <h5 className="md:hidden text-white font-bold mb-2">Fecha</h5>
            <span>2 de Mayo de 2024</span>
