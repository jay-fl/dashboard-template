...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`lg:h-[100vh] overflow-y-scroll fixed lg:static w-[80%] md:w-[40%] lg:w-full  h-full top-0 bg-secondary-100 p-4 flex flex-col justify-between z-50 ${
            ...
            <li>
              ...
              >
                <span className="flex items-center gap-4">
                  <RiGlobalLine className="text-primary" /> Redes sociales
                </span>
                <RiArrowRightSLine
                  className={`mt-1 ${
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 bg-primary text-black p-3 rounded-full z-50"
      >
